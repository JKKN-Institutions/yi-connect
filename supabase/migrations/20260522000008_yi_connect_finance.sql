-- ═══════════════════════════════════════════════════════════════════════
-- Migration: Financial Command Center lifted to yi_connect.*
-- Phase A Batch 6 — 1175 lines, 13 tables
--
-- Note: this migration uses unqualified table names (CREATE TABLE
-- budgets) rather than the schema-prefixed pattern used by other
-- migrations. We use SET search_path to route everything to
-- yi_connect.*, then patch chapters refs to yi.chapters.
-- ═══════════════════════════════════════════════════════════════════════
