-- ═══════════════════════════════════════════════════════════════════════
-- Migration: Stakeholder CRM lifted to yi_connect.*
-- Phase A Batch 7 — 1289 lines, biggest single migration in the lift.
--
-- Uses SET search_path approach (migration uses unqualified table
-- names like finance). chapters refs patched to yi.chapters.
-- ═══════════════════════════════════════════════════════════════════════
...
CREATE TABLE schools (
  ...
  -- Search
  search_vector tsvector  -- generation disabled (re-add via trigger if needed)
);
