...
export type BudgetAllocationUpdate = Database['public']['Tables']['budget_allocations']['Update']
...
export type ExpenseReceiptUpdate = Database['public']['Tables']['expense_receipts']['Update']
...
export type SponsorshipDeal = Database['public']['Tables']['sponsorship_deals']['Row']
export type SponsorshipDealInsert = Database['public']['Tables']['sponsorship_deals']['Insert']
export type SponsorshipDealUpdate = Database['public']['Tables']['sponsorship_deals']['Update']

export type SponsorshipPayment = Database['public']['Tables']['sponsorship_payments']['Row']
export type SponsorshipPaymentInsert = Database['public']['Tables']['sponsorship_payments']['Insert']
export type SponsorshipPaymentUpdate = Database['public']['Tables']['sponsorship_payments']['Update']

export type ReimbursementRequest = Database['public']['Tables']['reimbursement_requests']['Row']
export type ReimbursementRequestInsert = Database['public']['Tables']['reimbursement_requests']['Insert']
export type ReimbursementRequestUpdate = Database['public']['Tables']['reimbursement_requests']['Update']

export type ReimbursementApproval = Database['public']['Tables']['reimbursement_approvals']['Row']
...
export type SponsorshipTierLevel = 'platinum' | 'gold' | 'silver' | 'bronze' | 'supporter'
export type DealStage = 'prospect' | 'contacted' | 'proposal_sent' | 'negotiation' | 'committed' | 'contract_signed' | 'payment_received' | 'lost'
export type ReimbursementStatus = 'draft' | 'submitted' | 'pending_approval' | 'approved' | 'rejected' | 'paid'
export type ApprovalAction = 'approve' | 'reject' | 'request_changes'
export type PaymentMethodType = 'bank_transfer' | 'cash' | 'cheque' | 'upi' | 'credit_card' | 'online'
...
export interface SponsorshipDealFull extends SponsorshipDeal {
  sponsor: Sponsor
  tier?: SponsorshipTier
  payments: SponsorshipPayment[]
  event?: {
...
export interface ReimbursementRequestWithApprovals extends ReimbursementRequest {
...
export interface ReimbursementRequestFull extends ReimbursementRequest {
  approvals: (ReimbursementApproval & {
    approver: {
      id: string
      full_name: string
...
export interface FinancialReport {
  report_type: 'budget_variance' | 'expense_summary' | 'sponsorship_pipeline' | 'cash_flow' | 'income_statement'
  date_from: string
  date_to: string
  generated_at: string
...
export const SPONSORSHIP_TIER_LEVELS: Record<SponsorshipTierLevel, { label: string; color: string }> = {
...
export const REIMBURSEMENT_STATUSES: Record<ReimbursementStatus, { label: string; color: string }> = {
  draft: { label: 'Draft', color: 'gray' },
  submitted: { label: 'Submitted', color: 'blue' },
...
export function calculateUtilizationPercentage(spent: number, total: number): number {
  if (total === 0) return 0
...
export function isNearBudgetLimit(spent: number, total: number, threshold: number = 0.8): boolean {
