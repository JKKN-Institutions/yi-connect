/**
 * Schools Data Table Toolbar
 *
 * Toolbar with filters and actions for the schools data table
 */
...
interface SchoolsTableToolbarProps<TData> {
  table: Table<TData>
}
...
export function SchoolsTableToolbar<TData>({ table }: SchoolsTableToolbarProps<TData>) {
  ...
  return (
    <div className="flex items-center justify-between gap-2">
      <div className="flex flex-1 items-center space-x-2">
        ...
        />
        {table.getColumn('school_type') && (
          <DataTableFacetedFilter
            column={table.getColumn('school_type')}
            title="Type"
