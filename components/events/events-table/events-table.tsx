 ...
 *
 * Advanced data table for event management with server-side operations.
 */
...
import { EventsTableToolbar } from './toolbar'
...
export function EventsTable({ data, pageCount, isLoading }: EventsTableProps) {
