 ...
 * Schools Data Table
 *
 * Client-side data table component for schools with sorting, filtering, and pagination
 */
...
import { schoolsColumns } from './schools-table-columns'
...
export function SchoolsTable({ data }: SchoolsTableProps) {
  ...
  return (
    <div className="space-y-4">
      <SchoolsTableToolbar table={table} />
