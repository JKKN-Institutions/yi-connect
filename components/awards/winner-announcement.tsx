            ...
            >
              <CardHeader>
                <div className="flex items-center justify-between">
                  <Badge variant="outline" className={`${rankConfig.color} font-bold`}>
                    <RankIcon className="mr-1 h-4 w-4" />
                    {rankConfig.label}
                  </Badge>
                  <div className="text-right">
                    <div className="text-2xl font-bold">{winner.final_score.toFixed(2)}</div>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex flex-col items-center text-center space-y-3">
                  ...
                  <div>
                    <CardTitle className="text-xl">{nominee?.full_name || 'Unknown'}</CardTitle>
                ...
                {winner.announced_at && (
                  <div className="pt-4 border-t text-center">
                    <p className="text-xs text-muted-foreground">
                      Announced on{' '}
                      {formatDate(new Date(winner.announced_at), 'MMMM dd, yyyy')}
                    </p>
