...
export const metadata: Metadata = {
  ...
  description: "Comprehensive Yi Chapter Management System for unified member operations, events, finance, communication, and leadership.",
  keywords: ["Yi", "chapter management", "events", "members", "finance", "communication"],
