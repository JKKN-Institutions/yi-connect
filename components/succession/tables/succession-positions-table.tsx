  ...
  if (positions.length === 0) {
    return (
      <div className="text-center py-8 text-muted-foreground">
        ...
        <p className="text-xs mt-1">Add positions to start the succession process</p>
      </div>
    )
  }
            ...
            <TableRow key={position.id}>
              ...
              <TableCell>
                <Badge variant="outline">
                  Level {position.hierarchy_level} - {hierarchyLabels[position.hierarchy_level]}
                </Badge>
              </TableCell>
              <TableCell>
                <div className="text-sm font-medium">{position.number_of_openings}</div>
              </TableCell>
              <TableCell>
                {position.is_active ? (
              ...
              <TableCell className="text-right">
                <DropdownMenu>
                  ...
                  <DropdownMenuContent align="end">
                    ...
                    <DropdownMenuItem
                      onClick={() =>
                        router.push(`/succession/admin/positions/${position.id}`)
                      }
                    >
                    ...
                    <DropdownMenuItem
                      onClick={() =>
                        router.push(`/succession/admin/positions/${position.id}/edit`)
                      }
                    >
