...
async function NGOHeader({ ngoId }: { ngoId: string }) {
  ...
  const stats = [
    ...
    {
      label: 'Health Score',
      value: ngo.relationship_health_score?.current_score?.toFixed(0) || 'N/A',
      icon: TrendingUp,
    },
  ]
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <div className="flex items-center gap-3">
              ...
              {ngo.relationship_health_score && (
                <HealthTierBadge tier={ngo.relationship_health_score.health_tier} />
              )}
            </div>
