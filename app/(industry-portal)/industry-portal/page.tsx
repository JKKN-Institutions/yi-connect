...
import { CalendarPlus, Users, TrendingUp, Calendar, Clock, CheckCircle2, XCircle } from 'lucide-react';
...
import { getIndustryDashboardStats, getIndustryUpcomingSlots } from '@/lib/data/industrial-visits';
    ...
    return (
      <div className="flex flex-col items-center justify-center py-12">
        <p className="text-muted-foreground">
          You need to be authenticated as an industry user to access this portal.
        </p>
      </div>
    );
  }
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{stats.avg_capacity_utilization}%</div>
            <Progress value={stats.avg_capacity_utilization} className="mt-2 h-2" />
          </CardContent>
        </Card>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Common tasks to manage your industrial visits</CardDescription>
        </CardHeader>
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>Your next industrial visit opportunities</CardDescription>
            </div>
        ...
        <CardContent>
          {upcomingSlots.length === 0 ? (
            <div className="text-center py-8 text-muted-foreground">
              ...
              <p className="text-sm mb-4">Create your first industrial visit slot to get started</p>
              <Button asChild>
                <Link href="/industry-portal/slots/new">
                  <CalendarPlus className="mr-2 h-4 w-4" />
                  Create New Slot
                ...
                return (
                  ...
                  >
                    <div className="flex-1">
                      ...
                      <Progress value={capacityPercentage} className="mt-2 h-1.5" />
                    </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Tips for managing your industrial visits</CardDescription>
        </CardHeader>
        <CardContent className="space-y-3">
          <div className="flex gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">
                Set up an industrial visit opportunity with date, capacity, and details
              </p>
            </div>
          </div>
          <div className="flex gap-3">
            ...
            <div>
              <p className="font-medium text-sm">Yi Chapter Members Will Book</p>
              <p className="text-xs text-muted-foreground">
          ...
          <div className="flex gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">
                View registrations, export attendee lists, and increase capacity if needed
              </p>
            </div>
          </div>
        </CardContent>
