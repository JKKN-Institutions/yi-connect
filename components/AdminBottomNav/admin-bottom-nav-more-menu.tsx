...
import { AdminBottomNavMoreMenuProps } from './types';
import {
  Sheet,
  SheetContent,
  SheetHeader,
...
export function AdminBottomNavMoreMenu({
  groups,
  isOpen,
  onClose,
  onItemClick
}: AdminBottomNavMoreMenuProps) {
  ...
  return (
    <Sheet open={isOpen} onOpenChange={(open) => !open && onClose()}>
      ...
      >
        ...
        <div
          className="flex-1 overflow-y-auto pb-8 px-6"
          style={{
            scrollbarWidth: 'none',
            ...
            {groups.map((group) => {
              ...
              return (
                ...
                >
                  ...
                  <AccordionContent>
                    <div className="grid grid-cols-3 gap-3 pt-3 pb-4 px-2">
