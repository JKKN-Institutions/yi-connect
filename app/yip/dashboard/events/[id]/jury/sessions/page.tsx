...
export default async function JurySessionsPage({
  ...
  if (!event) {
    return (
      <Forbidden403 reason="You don't have access to this event's jury sessions. The event may have been deleted, or your role may not include this event's chapter or region." />
    );
  }
