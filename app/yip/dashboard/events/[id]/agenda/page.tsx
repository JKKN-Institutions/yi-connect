...
// client's row type (the column comes through getAgendaForSetup's select("*")).
...
export default async function AgendaSetupPage({
  ...
  if (!event) {
    return (
      <Forbidden403 reason="You don't have access to this event's agenda. The event may have been deleted, or your role may not include this event's chapter or zone." />
    );
  }
