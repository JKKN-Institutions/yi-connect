  ...
  return (
    <div className="flex flex-col gap-8 max-w-4xl mx-auto">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Record New Expense</h1>
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Record your expense by filling out the form below. You can save it as a draft or submit it for approval.
        </CardDescription>
      </CardHeader>
      <CardContent>
        <ExpenseForm
          chapterId={chapterId}
          onSuccess={() => {
            // Redirect is handled by the form action
          }}
        />
      </CardContent>
    </Card>
