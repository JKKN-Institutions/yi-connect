...
import { ArrowLeft, Edit, CheckCircle, XCircle, Receipt, User, Calendar, DollarSign } from 'lucide-react'
...
import { ExpenseStatusBadge, ExpenseCategoryBadge, PaymentMethodBadge } from '@/components/finance/status-badges'
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground">
              {expense.category && <span className="mr-2 text-sm font-medium">{expense.category.name}</span>}
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground mt-1">
              {expense.payment_method && <PaymentMethodBadge method={expense.payment_method} />}
            </p>
          </CardContent>
        </Card>
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">{expenseDate.toLocaleDateString()}</p>
            </div>
            <div>
          ...
          {expense.invoice_number && (
            <div>
              ...
              <p className="text-sm text-muted-foreground">{expense.invoice_number}</p>
            </div>
          )}
