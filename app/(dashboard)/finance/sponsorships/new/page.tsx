...
export const metadata = {
  ...
  description: 'Create a new sponsorship deal and track its progress through the pipeline',
}
      ...
      <CardContent>
        <div className="rounded-lg border-2 border-dashed p-12 text-center">
          ...
          <p className="text-sm text-muted-foreground">
            For now, sponsorship deals can be created directly in the database or via API.
          </p>
        </div>
      </CardContent>
    </Card>
  ...
  return (
    <div className="flex flex-col gap-8 max-w-4xl mx-auto">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Create Sponsorship Deal</h1>
